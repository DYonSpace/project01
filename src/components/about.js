    ...
    return(
        <div className="About">
            ...
            <section className="aboutSection">
                ...
                <div className="a3"><h4>당신의 오늘을 만드는 도구</h4></div>
                <div className="s3">
            ...
            <footer className="aboutFooter">
                ...
                <div className="f2">
                    <p>디지털과 아날로그를 넘나드는 나의 세상에서,</p>
                    <p>더 나은 내일을 위해</p>
                    <p>Today, Do your best!</p>
                </div>
            </footer>
        </div>
    );
